...
$getsql = mysqli_query($con, "select * from tbl_product  where id='1'");
...
<body>
                ...
                ";
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="tamtitle" class="form-control" placeholder="" value="<?php echo $name['name']; ?>" />
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $price['price']; ?>" />
                      </div>


                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> Brand : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $brand['brand']; ?>" />
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> Product Code : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $code['code']; ?>" />
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> Availability : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $available['available']; ?>" />
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> Size : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $size['size']; ?>" />
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> Quantity : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $quantity['quantity']; ?>" />
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="add-user-fullname"> keyword : &nbsp;&nbsp;<span style="color:red">*</span></label>
                        <input type="text" name="tamsubtitle" class="form-control" placeholder="" value="<?php echo $keyword['keyword']; ?>" />
                      </div>
  ...
  if ($name == ''  ||  $price == '' ||     $brand == '' ||  $code == '' ||  $available == '' ||  $size == '' ||  $quantity == '' || $img == '' || $keyword == '') {
    ...
    $sqlinsert = mysqli_query($con, "insert into tbl_product set img='$img', name='$name', price='$price', brand='$brand', code='$code', available='$availble', size='$size', quantity='$quantity', keyword='$keyword' ");
    if ($sqlinsert) {
