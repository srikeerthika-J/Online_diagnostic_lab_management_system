  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="container">
          <div class="mb-4">
            <a href="addlab.php"><button class="btn btn-primary">Add Lab</button></a>
          </div>
          <center><h4><b>Lab List</b></h4></center>
          <div class="table-responsive card" style="padding: 5px;">
            <table class="table border-top" id="myTable">
              ...
              <tbody>
                <?php
                $query = mysqli_query($con, "SELECT * FROM lab_names");
                $i = 1;
        ...
        success: function (response) {
          if (response.trim() === 'success') {
            ...
            $('#message').removeClass('alert-danger').addClass('alert-success')
              .text('lab deleted successfully!').fadeIn();
