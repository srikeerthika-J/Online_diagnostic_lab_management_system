...
if(isset($_POST['submit'])){
  ...
  $cat_name=$_POST['cat_name'];
	...
	//file upload
$insert = mysqli_query($con, "INSERT INTO lab_names (lab_name) VALUES ('$cat_name')");
...
<form class="add-new-user pt-0" method="post" enctype="multipart/form-data"> 
 <div class="row ">
     ...
     <center><h4>Add package </h4></center>
     ...
     <div class="mb-3">
        <label for="cat_name">Package Name</label>

<input type="text" autocomplete="off" class="form-control" placeholder="Enter package name" name="cat_name" value="" required>
