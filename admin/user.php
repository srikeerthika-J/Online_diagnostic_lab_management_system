  ...
  <div class="layout-wrapper layout-content-navbar  ">
    ...
    padding-top:25px; padding-left:0px;" />
          ...
          <div class=" table-responsive card" style="padding:5px">
            <table class="table border-top" id="myTable">
              ...
              <tbody>
                ...
                <?php
                $getplayersql = mysqli_query($con, "select * from lab_booking order by id desc");
                $sno = 1;
      ...
      <td>' . $sno . '			
            ...
            <td>' . $playerdata['number'] . '			
			</td>
            <td>' . $playerdata['email_id'] . '			
			</td>
            <td>' . $playerdata['age'] . '			
			</td>
            <td>' . $playerdata['address'] . '			
			</td>
          
 
		<td>
    <a href="view_booking.php?id=' . $playerdata['id'] . '"><button  class="btn btn-success" type="button">View</button></a>
    <a href="user.php?id=' . $playerdata['id'] . '"><button type="button" class="btn btn-danger"><font color="white">Delete</font></butotn></a>
    </td>
