      ...
      <div class="layout-page">
        ...
        <div class="container">
          <div class="mb-4">
            ...
            <a href="addproduct.php"><button class="btn btn-primary">Add Test</button></a>
          </div>
          <center><h4><b>Lab Test List</b></h4></center>
          <div class="table-responsive card" style="padding: 5px;">
            <table class="table border-top" id="myTable">
              ...
              <tbody>
                <?php
                $query = mysqli_query($con, "SELECT * FROM lab_tests");
                $i = 1;
                if (mysqli_num_rows($query) > 0) {
                  while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<tr id='row_$id'>
                            ...
                            <td>{$row['test_name']}</td>
                            <td>
                              <a href='edittest.php?id=$id' class='btn btn-sm btn-primary'><font color='white'>Edit</font></a>
        ...
        success: function (response) {
          if (response.trim() === 'success') {
            ...
            $('#message').removeClass('alert-danger').addClass('alert-success')
              .text('Test deleted successfully!').fadeIn();
            ...
            $('#message').removeClass('alert-success').addClass('alert-danger')
              .text('Error deleting test: ' + response).fadeIn();
          }
