                  ...
                  <div class="row ">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" autocomplete="off" class="form-control" placeholder="Product Category" name="cat_name" value="<?php echo  $galdata['cat_name']; ?>">
...
if (isset($_POST['update'])) {
  ...
  //file upload
  $insert = mysqli_query($con, "update tbl_category set cat_name='$cat_name' where id='$id'");
